...
public class TCPComm {
	public static final String SERVER_IP = "192.168.15.15";	// Rasp Pi: 192.168.15.15
	...
	public TCPComm() {
		try {
			...
			MainFile.gui.setModeColour(false);
		}
	}
	...
	public static String genMDFBluetooth(Map map, Robot robot) {
		...
		toReturn = "MDF" + "|" + map.getP1Descriptors() + "|" + map.getP2Descriptors() + "|" + robot.getcurDir() + "|"
				+ (19 - robot.getcurPos().getY()) + "|" + robot.getcurPos().getX() + "|" + "0";
