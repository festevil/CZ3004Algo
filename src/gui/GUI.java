	...
	*/
	...
	private void setCellBorder(Cell curCell, JLabel jl) {
		switch(curCell.getCellType()) {
			case Cell.NORTHWALL:
				jl.setBorder(BorderFactory.createMatteBorder(10, 1, 1, 1, Color.red));
				break;
			case Cell.EASTWALL:
				jl.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 10, Color.red));
				break;
			case Cell.SOUTHWALL:
				jl.setBorder(BorderFactory.createMatteBorder(1, 1, 10, 1, Color.red));
				break;
			case Cell.WESTWALL:
				jl.setBorder(BorderFactory.createMatteBorder(1, 10, 1, 1, Color.red));
				break;
			case Cell.PATH:
